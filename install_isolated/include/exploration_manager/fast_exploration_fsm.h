...
private:
  ...
  ros::Subscriber trigger_sub_, odom_sub_, keyborad_sub_;
  ...
  void navPathTriggerCallback(const nav_msgs::PathConstPtr& msg);
  void odometryCallback(const nav_msgs::OdometryConstPtr& msg);
  void visualize();
  void clearVisMarker();

  /* receive control topic from keyboard_input node */ 
  void keyboardControlCallback(const std_msgs::StringConstPtr& msg);
