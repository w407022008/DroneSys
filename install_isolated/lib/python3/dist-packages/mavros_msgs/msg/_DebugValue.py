...
class DebugValue(genpy.Message):
  _md5sum = "a385507a0141af80b5f68662747f1e68"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','string','float32','int32','float32[]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,index,array_id,name,value_float,value_int,data,type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.index, _x.array_id))
      _x = self.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.index, _x.array_id,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
