...
(cl:ensure-generic-function 'array_id-val :lambda-list '(m))
(cl:defmethod array_id-val ((m <DebugValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_msgs-msg:array_id-val is deprecated.  Use mavros_msgs-msg:array_id instead.")
  (array_id m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DebugValue>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'array_id)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DebugValue>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'array_id) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DebugValue>)))
  ...
  "a385507a0141af80b5f68662747f1e68")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DebugValue)))
  "Returns md5sum for a message object of type 'DebugValue"
  "a385507a0141af80b5f68662747f1e68")
