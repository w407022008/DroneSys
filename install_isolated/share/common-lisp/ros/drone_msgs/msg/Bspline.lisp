...
(cl:defmethod cl:initialize-instance :after ((m <Bspline>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bspline)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_msgs-msg:<Bspline> is deprecated: use drone_msgs-msg:Bspline instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_msgs-msg:order-val is deprecated.  Use drone_msgs-msg:order instead.")
  (order m))

(cl:ensure-generic-function 'traj_id-val :lambda-list '(m))
(cl:defmethod traj_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_msgs-msg:traj_id-val is deprecated.  Use drone_msgs-msg:traj_id instead.")
  (traj_id m))

(cl:ensure-generic-function 'knots-val :lambda-list '(m))
(cl:defmethod knots-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_msgs-msg:knots-val is deprecated.  Use drone_msgs-msg:knots instead.")
  (knots m))

(cl:ensure-generic-function 'pts-val :lambda-list '(m))
(cl:defmethod pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_msgs-msg:pts-val is deprecated.  Use drone_msgs-msg:pts instead.")
  (pts m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_msgs-msg:start_time-val is deprecated.  Use drone_msgs-msg:start_time instead.")
  (start_time m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Bspline>)))
  ...
  (cl:format cl:nil "int32 order                 ## ~%int64 traj_id               ## id of trajecotry~%float64[] knots             ## knots list~%geometry_msgs/Point[] pts   ## control points list~%time start_time             ## time stamp~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Bspline)))
  "Returns full string definition for message of type 'Bspline"
  (cl:format cl:nil "int32 order                 ## ~%int64 traj_id               ## id of trajecotry~%float64[] knots             ## knots list~%geometry_msgs/Point[] pts   ## control points list~%time start_time             ## time stamp~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
