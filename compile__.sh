...
catkin_make --source Modules/slam/msckf_vio/ --build build/slam/msckf_vio --cmake-args -DCMAKE_BUILD_TYPE=Release -j3
catkin_make --source Modules/slam/msckf_mono --build build/slam/msckf_mono -j3
