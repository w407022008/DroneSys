...
def depth_callback(data):
	...
	frame = cv2.Canny(boundary_mask,30,90)
	...
	image_msg = bridge.cv2_to_imgmsg(filtered_image, encoding="mono8")
...
if __name__=='__main__':
	...
	rospy.Subscriber("/sipeed_tof/depth_raw", Image, depth_callback)
