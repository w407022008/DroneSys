...
#endif
#if defined(_WIN32) && defined(CAN_FORWARD)
  #undef CAN_FORWARD
#endif
...
struct MD5Sum< ::mavros_msgs::CommandCode_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x059d72cceadaa0abULL;
  static const uint64_t static_value2 = 0xca57de773508431cULL;
};
