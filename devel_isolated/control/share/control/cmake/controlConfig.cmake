...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/sique/src/DroneSys_sim/Modules/control/control)
  set(control_DEVEL_PREFIX /home/sique/src/DroneSys_sim/devel_isolated/control)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/sique/src/DroneSys_sim/install_isolated)
...
if(NOT "/home/sique/src/DroneSys_sim/Modules/control/control/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/sique/src/DroneSys_sim/Modules/control/control/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sique/src/DroneSys_sim/Modules/control/control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sique/src/DroneSys_sim/devel_isolated/control/lib;/home/sique/src/DroneSys_sim/install_isolated/lib;/opt/ros/noetic/lib)
