...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/sique/src/DroneSys_sim/Modules/utils/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/sique/src/DroneSys_sim/devel_isolated/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/sique/src/DroneSys_sim/install_isolated)
...
if(NOT "/home/sique/src/DroneSys_sim/Modules/utils/mavros/libmavconn/include;/usr/include;/opt/ros/noetic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/sique/src/DroneSys_sim/Modules/utils/mavros/libmavconn/include;/usr/include;/opt/ros/noetic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sique/src/DroneSys_sim/Modules/utils/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sique/src/DroneSys_sim/devel_isolated/libmavconn/lib;/home/sique/src/DroneSys_sim/install_isolated/lib;/opt/ros/noetic/lib)
