...
class pos_controller_cascade_PID
{
    ...
    public:
        ...
        drone_msgs::ControlOutput _ControlOutput;
        ...
        drone_msgs::ControlOutput pos_controller(const drone_msgs::DroneState& _DroneState, const drone_msgs::PositionReference& _Reference_State, float dt);

        //Position control loop [Input: current pos, desired pos; Output: desired vel]
        void _positionController(const drone_msgs::DroneState& _DroneState, const drone_msgs::PositionReference& _Reference_State, Eigen::Vector3d& vel_setpoint);

        //Velocity control loop [Input: current vel, desired vel; Output: desired thrust]
        void _velocityController(const drone_msgs::DroneState& _DroneState, const drone_msgs::PositionReference& _Reference_State, float dt, Eigen::Vector3d& thrust_sp);
...
drone_msgs::ControlOutput pos_controller_cascade_PID::pos_controller
    (const drone_msgs::DroneState& _DroneState, 
     const drone_msgs::PositionReference& _Reference_State, 
     float dt)
{
    delta_time = dt;
...
void pos_controller_cascade_PID::_velocityController
    (const drone_msgs::DroneState& _DroneState, 
     const drone_msgs::PositionReference& _Reference_State, float dt,
     Eigen::Vector3d& thrust_sp)
{
