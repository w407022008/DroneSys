...
void GeometricPositionController::SetRollPitchYawrateThrust(
  ...
  controller_mode_ = Modes::RP_YAWRATE;
}
...
void GeometricPositionController::SetTrajectoryPoint(
  ...
  controller_active_ = true;
  controller_mode_ = Modes::PVA_YAWRATE;
}
...
void GeometricPositionController::ComputeDesiredAngularAcc(Eigen::Vector3d* angular_acceleration) const {
  ...
  Eigen::Vector3d angular_rate_des_proj = R.transpose() * R_des * angular_rate_des;
  Eigen::Vector3d angular_rate_error = odometry_.angular_velocity - angular_rate_des_proj;
...
void GeometricPositionController::ComputeDesiredAngularAcc(const Eigen::Vector3d& acceleration,
