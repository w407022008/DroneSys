...
//    string input_file = "/home/taojiang/Downloads/freiburg1_360.bt";
    ...
    pub_octomap = node.advertise<octomap_msgs::Octomap>("/fast_planner/octomap", 1, true);
    pub_inf_octomap = node.advertise<octomap_msgs::Octomap>("/fast_planner/inflate_octomap", 1, true);
    pub_pcd = node.advertise<sensor_msgs::PointCloud2>("/fast_planner/pcd", 1, true);
    pub_inf_pcd = node.advertise<sensor_msgs::PointCloud2>("/fast_planner/inflate_pcd", 1, true);
