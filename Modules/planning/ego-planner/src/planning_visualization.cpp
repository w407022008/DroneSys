...
namespace ego_planner
{
  PlanningVisualization::PlanningVisualization(ros::NodeHandle &nh)
  {
    ...
    goal_point_pub = nh.advertise<visualization_msgs::Marker>("/ego_planner/goal_point", 2);
    global_list_pub = nh.advertise<visualization_msgs::Marker>("/ego_planner/global_list", 2);
    init_list_pub = nh.advertise<visualization_msgs::Marker>("/ego_planner/init_list", 2);
    optimal_list_pub = nh.advertise<visualization_msgs::Marker>("/ego_planner/optimal_list", 2);
    a_star_list_pub = nh.advertise<visualization_msgs::Marker>("/ego_planner/a_star_list", 20);
  }
