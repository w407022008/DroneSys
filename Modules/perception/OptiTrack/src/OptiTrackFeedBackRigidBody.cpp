...
void OptiTrackFeedBackRigidBody::PushPose()
{
    ...
    pose[1].t = t_current;
    pose[1].Stamp = OptiTrackdata.header.stamp;
    ...
    */
    ...
    L <<  - pose[1].q1,   pose[1].q0,   pose[1].q3, - pose[1].q2,
          - pose[1].q2, - pose[1].q3,   pose[1].q0,   pose[1].q1,
          - pose[1].q3,   pose[1].q2, - pose[1].q1,   pose[1].q0;
    R <<  - pose[1].q1,   pose[1].q0, - pose[1].q3,   pose[1].q2,
          - pose[1].q2,   pose[1].q3,   pose[1].q0, - pose[1].q1,
          - pose[1].q3, - pose[1].q2,   pose[1].q1,   pose[1].q0;
          
    pose[1].R_IB = R * L.transpose();
...
{
    state.Stamp = pose[0].Stamp;
    state.time_stamp = pose[0].t;
    state.Position = pose[0].Position;
    state.Velocity = velocity_filtered;
    state.Omega_B = angular_velocity_filtered;
    Hatmap(state.Omega_B,state.Omega_Cross);
    state.R_IB = pose[0].R_IB;
    state.R_BI = pose[0].R_BI; 
    double euler_temp[3];
...
void  OptiTrackFeedBackRigidBody::Reset()
{
