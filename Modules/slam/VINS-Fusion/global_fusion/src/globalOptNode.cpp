...
void odom_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    if(save_to_file){
        std::ofstream foutC(output_path, ios::app);
...
int main(int argc, char **argv)
{
    ...
    output_path = "/home/sique/output/vio_global.csv";
    save_to_file = false;

    global_path = &globalEstimator.global_path;

    ros::Subscriber sub_GPS = n.subscribe("/gps", 100, GPS_callback);
    ros::Subscriber sub_vio = n.subscribe("/vins_estimator/odometry", 100, odom_callback);
    ros::Subscriber sub_orb = n.subscribe("/orb_slam3_ros/camera", 100, pose_callback);
