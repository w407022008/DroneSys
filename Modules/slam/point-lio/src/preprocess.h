...
enum LID_TYPE{AVIA = 1, VELO16, OUST64, HESAIxt32, UNILIDAR}; //{1, 2, 3, 4, 5}
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process_cut_frame_livox(const point_lio::LivoxMsg::ConstPtr &msg, deque<PointCloudXYZI::Ptr> &pcl_out, deque<double> &time_lidar, const int required_frame_num, int scan_count);
  ...
  void process(const point_lio::LivoxMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out);
  ...
  private:
  void avia_handler(const point_lio::LivoxMsg::ConstPtr &msg);
