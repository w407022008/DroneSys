...
void Preprocess::process(const point_lio::LivoxMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out)
{  
  avia_handler(msg);
  *pcl_out = pl_surf;
}
...
// useless: cut_frame_init = false;
void Preprocess::process_cut_frame_livox(const point_lio::LivoxMsg::ConstPtr &msg,
...
void Preprocess::process_cut_frame_pcl2(const sensor_msgs::PointCloud2::ConstPtr &msg, deque<PointCloudXYZI::Ptr> &pcl_out,
    ...
    int required_cut_num = required_frame_num; // 1 actually
...
void Preprocess::avia_handler(const point_lio::LivoxMsg::ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
